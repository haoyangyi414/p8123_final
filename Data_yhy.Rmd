...
data = data %>%
   mutate(age = case_when(RIDAGEMN<=39 ~ 1,
                          RIDAGEMN>=40 & RIDAGEMN <=59 ~2,
                          RIDAGEMN>=60 ~ 3))
data$age <- factor(data$age, levels = 1: 3, labels =c("20-39", "40-59", "60 and above"))
...
?barplot
barplot(b,beside=T,names.arg(),main="Proportions of Diabete across race and smoke status")
table(df1$HEALTH)
