...
barplot(b,beside=F,names.arg=c('smoked.Black','Non-smoked.Black','smoked.White','Non-smoked.White','smoked.other','Non-smoked.other'),main="Proportions of Diabete across race and smoke status")
...
l = svyby(~outcome,~RIDRETH1+SMQ040,design=des,svymean)

barplot(l,beside=F,main="Proportions of Diabete across race and smoke status")
